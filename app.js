...
<pre>curl -H "x-argokey: &lt;your API token&gt;" "http://3.88.185.52:8080/argo?platform=6902740"</pre>
...
<p>Full API docs can be found at <a href='http://3.88.185.52:8080/docs/'>http://3.88.185.52:8080/docs/</a>; don't hesitate to reach out to the team at argovis@colorado.edu if you run into trouble or have bug reports or feature requests.</p>`
            }
            ...
            if(response.code == 11000){
                ...
                query.exec(function(err, u){
                    ...
                    var msg = {
                      ...
                      <p>You may rotate this key at http://3.88.185.52:3030/.</p>`
                    }
    ...
    user.findOneAndUpdate({"email": req.body['rotate-email'], "key": req.body['rotate-key']}, {"key": k},{"new": true}).then(function(response){
        if(response){
            var msg = {
              ...
              <p>You may rotate this key again any time at http://3.88.185.52:3030/.</p>`
            }
